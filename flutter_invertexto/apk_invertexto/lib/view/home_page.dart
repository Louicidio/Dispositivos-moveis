...
import 'package:apk_invertexto/view/verifica_cpf_page.dart';
import 'package:apk_invertexto/view/verifica_email_page.dart';
        ...
        child: Column(
          children: <Widget>[
            ...
            GestureDetector(
              child: Row(
                children: <Widget>[
                  Icon(Icons.whatshot, color: Colors.white, size: 50),
                  SizedBox(width: 30),
                  Text(
                    'Verifica Email',
                    style: TextStyle(color: Colors.white, fontSize: 20),
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => VerificaEmailPage()),
                );
              },
            ),
             SizedBox(height: 30),
            GestureDetector(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => VerificaCpfPage()),
                );
              },
            )
          ],
